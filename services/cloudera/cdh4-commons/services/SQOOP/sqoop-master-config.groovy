...
println "sqoop-master-config.groovy: api url is: ${restCli.apiUrl}..."

//testing the availibility of the api
if(!restCli.isApiAvailable(60)){
	println "sqoop-master-config.groovy: REST API not available! exiting"
	System.exit(1)
}
