...
service {
	...
	//Semaphore updateHostsLock = new Semaphore(1, true)
	...
	lifecycle{
		...
		init "mysql-init.groovy"

		install "mysql_install.groovy"

		postInstall "mysql-postInstall.groovy"
	...
	customCommands ([
		...
		"query_file" : "mysql_query_file.groovy" ,
		...
		/*
		 This custom command updates the /etc/hosts file of the instance
		 Usage :  invoke mysql updateHost
		 */
		"updateHosts" : {
